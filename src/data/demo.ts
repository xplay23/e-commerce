...
export const demoCategories: Category[] = [
  ...
  slug: slug!,
  name: name!,
  description: `Considered ${name!.toLowerCase()} essentials`,
  image_url: null,
  created_at: now,
}))
const raw = [
  ...
  [
    ...
    120,
    20,
    'https://images.unsplash.com/photo-1603899122634-f086ca5f5ddd?auto=format&fit=crop&w=1000&q=85',
  ],
  [
    'Contour Keyboard',
    'workspace',
  ...
  [
    ...
    160,
    6,
    'https://images.unsplash.com/photo-1583845112203-454c2254edc7?auto=format&fit=crop&w=1000&q=85',
  ],
  [
    'Balance Diffuser',
    'wellness',
...
export const demoProducts: Product[] = raw.map((p, i) => {
  const category = demoCategories.find((c) => c.slug === p[1])!
  return {
    id: `10000000-0000-4000-8000-${String(i + 1).padStart(12, '0')}`,
    category_id: category.id,
    name: p[0],
    slug: p[0].toLowerCase().replace(/ /g, '-'),
    description: `Designed with restraint and made to last. The ${p[0]} brings quiet function to your everyday rituals, using honest materials and thoughtful details.`,
    short_description: 'Quietly functional. Intentionally made.',
    price: p[2],
    old_price: p[3],
    stock: p[4],
    image_url: p[5],
